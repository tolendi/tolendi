...
* Data analysis and exploration (Python, Pandas)
...
* [Анализ обеспеченности населения кинотеатрами в Республике Казахстан](https://public.tableau.com/views/2026_17784848242150/sheet0?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) - интерактивный дашборд в Tableau для анализа с визуализацией
* [Мониторинг цен на социально значимые товары (СЗПТ) в Казахстане (2022–2026)](https://public.tableau.com/views/KazakhstanFoodPriceMonitoring2022-2026/sheet0?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) - end-to-end data pipeline: автоматизация сбора (scraping), очистка нестабильных excel-данных (pandas), устранение дублей и построение интерактивного дашборда в Tableau для мониторинга инфляции ([полное описание](https://github.com/tolendi/kazakhstan-food-prices/blob/main/README.md))
...
⭐ Always focused on building practical skills through real projects.
